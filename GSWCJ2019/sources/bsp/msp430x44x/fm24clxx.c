...
#define SDA_IN()         do{P3DIR_bit.P5 = 0;}while(0)
#define SDA_OUT()        do{P3DIR_bit.P5 = 1;}while(0)

#define SDA_L()         do{P3OUT_bit.P5 = 0;}while(0)
#define SDA_H()         do{P3OUT_bit.P5 = 1;}while(0)
#define SDA_READ()      P3IN_bit.P5

#define SCL_L()         do{P3OUT_bit.P6 = 0;}while(0)
#define SCL_H()         do{P3OUT_bit.P6 = 1;}while(0)

#define WP_L()          do{P3OUT_bit.P7 = 0;}while(0)
#define WP_H()          do{P3OUT_bit.P7 = 1;}while(0)
