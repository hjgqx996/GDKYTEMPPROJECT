 ...
 */
#define SYS_LSE_CLOCK_HZ               ( ( uint32_t ) 32768 )
#define SYS_CPU_CLOCK_HZ               ( SystemCoreClock )
#define SYS_TICK_RATE_HZ               ( ( uint32_t ) 100 )

#define SYSGetTickCount()              1
#define SYSGetTickCountISR()           1
#define SYS_MS_TO_TICKS(ms)            (ms)

//#define SYSGetRunSec()                 g_tSysTime.runsec
//#define SYSGetTimeSec()                SysTimeGetSecond()
//#define SYSGetTimeSecEx(y,m,d,h,min,s) SysMakeSecond(y,m,d,h,min,s)
//#define SYSMakeDateTime(sec, ptime)    SysMakeDateTime(sec, ptime)

#define SYSGetRunSec()                 1
#define SYSGetTimeSec()                1
#define SYSGetTimeSecEx(y,m,d,h,min,s) 1
#define SYSMakeDateTime(sec, ptime)    (sec, ptime)
...
#define SYSMalloc(size)                NULL
#define SYSFree(ptr)

#define SYSEnterCritical()             __disable_interrupt()
#define SYSExitCritical()              __enable_interrupt()
